...
import com.theprophet.a7minuteworkout.databinding.ActivityExerciseBinding
import com.theprophet.a7minuteworkout.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.theprophet.a7minuteworkout/" + R.raw.app_src_main_res_raw_press_start)
    ...
    private fun customDialogForBackButton() {
        ...
        val dialogBinding = com.theprophet.a7minuteworkout.databinding.DialogCustomBackConfirmationBinding.inflate(layoutInflater)
